// -------------------------
// khai bao HTML element can su dung
...
// -------------------------
// xu ly su kien submit from dang nhap
function signin() {
  // lay du lieu input
  ...
  if (userData) {
    ...
    if (userObj.password === password) {
      ...
      //chuyen huong ce trang chu
      location.href = "../index.html";
    } else {
      //sai pass
      alert("sai thong tin dangn nhap");
      return;
    }
  } else {
...
function validateSignupData(username, email, password, confirmPassword) {
  ...
  if (confirmPassword !== password) {
    alert("password va confirmPassword can phai giong nhau");
    return false;
  }
...
// -------------------------
// xu ly su kien submit from dang ky (luu tru du lieu vao local storage)
function signup() {
  ...
  if (isValid) {
    ...
    // luu tru du lieu vao local storage
...
//--------------------------
// chuyen doi giau dang nhap va dang ky
